...
function BodyFirstPart() {
  return (
    <div>
      ...
      {/* Bottom Box */}
      <section class="flex justify-center pb-75px">
        <div class="flex flex-col w-1230px max-w-full items-center relative z-10 px-7.5">
          <div class="block">
            <div class="overflow-hidden m-[-15px] translate-y-[-50%] shadow-sm rounded-lg block">
              <div class="relative block">
                <div
                  class="flex flex-row px-28 box-border items-center justify-center box-border"
                  style={{
                    backgroundImage:
                ...
                >
                  <img
                    class="flex-1 w-[250px] h-[200px] my-[-1.75rem] border-0 max-w-full object-contain"
