...
function SmallHeader() {
    ...
    const languageList = ["English", "Deutsch", "Français", "Português", "Español"];
    const supportList = ["Help Center", "Talk to Support", "Training", "Support Plans", "Partner Solutions"];
                        ...
                        <ul class="flex flex-col mt-4 bg-gray-50 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                            <li>
                                <button id="dropdownNavbarLink" onClick={showLanguageDropdown} data-dropdown-toggle="dropdownNavbar" class="flex justify-between items-center h-full py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">
                                    ...
                                    <div class="pr-1"></div>
                                    <p class="text-xs text-blue-900 font-semibold whitespace-nowrap items-center" >English</p>
                                    <KeyboardArrowUpIcon className="text-blue-900 transform rotate-180 transition duration-1000" fontSize="small" />
                                </button>
                                {isLanguageDropdown && <div class="z-50 absolute top-5px border-1 border-gray-200 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                                    <ul role="none">
                            ...
                            <li>
                                <button id="dropdownNavbarLink" onClick={console.log("telephone clicked")} data-dropdown-toggle="dropdownNavbar" class="flex justify-between items-center h-full py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">
                                    <PhoneIcon className="pr-0.5 text-blue-900 " fontSize="extra-small" />
                                    <div class="pr-1"></div>
                                    <p class="text-2xs text-blue-900 font-semibold tracking-widest whitespace-nowrap items-center" >+353 1 592 1002</p>
                                </button>
                            </li>
                            <li>
                                <button id="dropdownNavbarLink" onClick={showSupportDropdown} data-dropdown-toggle="dropdownNavbar" class="flex justify-between items-center h-full py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">
                                    <p class="text-xs text-blue-900 font-semibold whitespace-nowrap items-center" >Support</p>
                                    <KeyboardArrowUpIcon className="text-blue-900 transform rotate-180 transition duration-1000" fontSize="small" />
                                </button>
                                {isSupportDropdown && <div class="z-50 absolute top-5px border-1 border-gray-200 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                            ...
                            <li>
                                <button id="dropdownNavbarLink" onClick={console.log("Login clicked")} data-dropdown-toggle="dropdownNavbar" class="flex justify-between items-center h-full py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">
