  ...
  return (
    <div id="small-header">
      <nav className="bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
        <div className="container flex flex-wrap px-2 py-2.5 mx-auto justify-end">
          <button
          ...
          <div className="w-min " id="navbar-solid-bg">
            <ul className="flex flex-col mt-4 bg-gray-50 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
              <li>
                <button
                  ...
                  className="flex justify-between items-center h-full py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
                >
                  <LanguageIcon
                  ...
                  <p className="text-xs text-blue-900 font-semibold whitespace-nowrap items-center">
                    English
                  </p>
                  <KeyboardArrowUpIcon
              ...
              <li>
                ...
                >
                  ...
                  />
                  <div className="pr-1"></div>
                  <p className="text-2xs text-blue-900 font-semibold tracking-widest whitespace-nowrap items-center">
                    +353 1 592 1002
                  </p>
                </button>
              </li>
